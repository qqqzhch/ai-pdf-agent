...
class ToImageConverter(BasePlugin):
    """Image 转换器 - 将 PDF 页面转换为图片格式（PNG, JPEG, WEBP 等）"""

    # 插件元数据
    name = "image_converter"
    version = "1.0.0"
    description = "将 PDF 页面转换为图片格式（PNG, JPEG, WEBP 等），支持 DPI 和分辨率设置"
